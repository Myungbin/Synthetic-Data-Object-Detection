...
def main():
    config = r"C:\MB_Project\project\Competition\VISOL\mmdetection\configs\visol\best\969\0601_model.py"
    checkpoint = r'C:\MB_Project\project\Competition\VISOL\mmdetection\configs\visol\best\969\latest.pth'
    device = 'cuda:0'
    # build the model from a config file and a checkpoint file
    model = init_detector(config, checkpoint, device=device)
    # test a single image
    # img = r"C:\MB_Project\project\Competition\VISOL\data\train\syn_00025.png"
    img = r"C:\MB_Project\project\Competition\VISOL\data\test\075817746.png"
    ...
    for feature in x_fpn:
        ...
        cv2.imwrite('feature_map/' + 'P' + str(feature_index) + '_heatmap.jpg', heatmap_image)
